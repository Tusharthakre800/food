  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.resetToken) {
        setResetLink(`/partner/reset-password/${response.data.resetToken}`);
      }
    } catch (error) {
      ...
      <div className="w-full flex items-center justify-center p-6 sm:p-12 mt-12 lg:mt-0">
        <div className="w-full max-w-md space-y-8 bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-800">
          ...
          <div className="text-center mt-4">
            <Link to="/partner/login" className="inline-flex items-center text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-primary transition-colors">
